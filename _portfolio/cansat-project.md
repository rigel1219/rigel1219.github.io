...
#### 위성 촬영 영상
실제 캔위성 비행 중 탑재된 카메라로 촬영한 영상입니다.
...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-bottom: 30px;">
  <div style="flex: 1; min-width: 300px;">
    ...
    <p style="text-align: center; color: gray; font-size: 0.9em; margin-top: 5px;">[영상 1] Payload Camera</p>
  </div>
  <div style="flex: 1; min-width: 300px;">
    ...
    <p style="text-align: center; color: gray; font-size: 0.9em; margin-top: 5px;">[영상 2] Bonus Container Camera</p>
  </div>
</div>
